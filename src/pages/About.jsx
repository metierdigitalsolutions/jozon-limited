  ...
  return (
    <main className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-4xl font-bold text-[#263FAF] mb-4">About JOZON NIGERIA LIMITED</h1>
        <p className="text-gray-700 leading-relaxed text-lg">
          JOZON NIGERIA LIMITED is a multi-industry company dedicated to producing essential products that support healthier living and stronger businesses.
